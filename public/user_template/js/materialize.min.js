...
!(function(t) {
	...
	var x,
		...
		I = function() {},
		S = function(t) {
			return typeof t == typeof I && t.call;
		},
		A = function(t) {
	...
	function B(t) {
		...
		function s(t) {
			...
			if ((i = Object.keys(n).length))
				for (s = 0; s < i; s++)
					I ||
						(I = p(document.body, "transform")
							? "transform"
							: "-webkit-transform"),
						(v.animatables[s].target.style[I] = n[s].join(" "));
		...
		function r(t) {
			...
			if (v.children.length) {
				var y = v.children,
					_ = y.length;
				if (g >= v.currentTime) for (var k = 0; k < _; k++) y[k].seek(g);
							...
							},
							{
								...
								value: function(e, i) {
									...
									s.sort(function(t, e) {
										...
										t(this.container).css({ display: "block" });
